...
import register from "../assets/1.png"
import directions from "../assets/4.png"
import parking from "../assets/parking.png"

const AllStars = () => {
  return (
    <div className="bg-yellow-300 min-h-screen w-full px-4 py-10 text-black font-sans">
...
<div className="text-center space-y-2">
  ...
  <p className="text-pink-700 text-2xl sm:text-4xl font-semibold">
    Registration starts 12 March 2025 (Spaces are limited)
        ...
        <div className="p-6 sm:p-10 rounded-xl space-y-4 text-center">
          ...
          AllStars cricket is a brilliant introduction to cricket –It’s part of a
          national programme run by the England & Wales Cricket Board.
          </h3>

          <div className="grid grid-cols-1 sm:grid-cols-2 gap-6 text-left">
            <ul className="space-y-2 list-disc pl-6 text-pink-700">
              <li>Boys and girls ages 5–8 years</li>
              <li>Sunday mornings 10am - 11am</li>
              <li>8 sessions starting from 18 May 2025</li>
              <li><strong>Cost £50</strong> (includes backpack, bat, ball and T-shirt for every child registered)</li>
            </ul>
            <ul className="space-y-2 list-disc pl-6 text-pink-700">
        ...
        <div className="p-6 sm:p-10 rounded-xl space-y-4">
          ...
          <div className="text-center space-y-1">
            <p className="text-pink-700 font-semibold">Mr. Afaq Punjabi</p>
            <p className="text-pink-700 font-semibold">Phone: 07958044726</p>
            <div className="flex justify-center">
        ...
        <div className="p-6 sm:p-10 rounded-xl space-y-4 text-center">
          ...
          <a
            href="https://ecb.clubspark.uk/Book/bd915138-2728-4ff9-b20b-b3010ee2fd2f?"
            target="_blank"
            rel="noopener noreferrer"
            className="text-blue-700 underline break-words"
          >
            https://ecb.clubspark.uk/Book/bd915138-2728-4ff9-b20b-b3010ee2fd2f?venue=ChelsfieldCricketClub
          </a>
