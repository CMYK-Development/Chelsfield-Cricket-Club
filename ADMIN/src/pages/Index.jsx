...
const Index = () => {
    ...
    const fetchAdminData = async () => {
        try {
            ...
            setFilteredAdmins(response.data); // Set the filtered admins
        } catch (error) {
    ...
    return (
        <div>
            <ul className="flex space-x-2 rtl:space-x-reverse">
                <p className="text-black text-xl  dark:text-white-light">Dashboard</p>
            </ul>
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 mb-6">
                    <div className="panel h-full">
                        <div className="flex items-center mb-5">
                            <h5 className="font-semibold text-lg dark:text-white-light">Latest News</h5>
                            <div className="ltr:ml-auto rtl:mr-auto relative">
                                <div className="w-11 h-11 text-warning bg-[#ffeccb] dark:bg-warning dark:text-[#ffeccb] grid place-content-center rounded-full">
                                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 256 256" className="w-full h-full" fill="#fbc932">
                        ...
                        <div>
                            <div className="bg-white dark:bg-black rounded-lg">
                                {loading ? (
                                    ...
                                    <div>
                                        <h5 className="font-semibold text-2xl dark:text-white-light">{counts.news}</h5>
                                    </div>
                                )}
                            </div>
                        </div>
                            ...
                            <div className="bg-white dark:bg-black rounded-lg">
                                {loading ? (
                                    ...
                                    <div className="flex justify-between items-center">
                                        <h5 className="font-semibold text-2xl dark:text-white-light">{counts.images}</h5>
